...
```*/
    ...
    ///Container for all the [`IWETH`](self) events.
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for IWETHEvents {
        const NAME: &'static str = "IWETHEvents";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for IWETHEvents {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
                Self::Approval(inner) => {
