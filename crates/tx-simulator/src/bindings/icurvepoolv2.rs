...
```*/
    ...
    /**Function with signature `get_dy(uint256,uint256,uint256)` and selector `0x556d6e9f`.
```solidity
function get_dy(uint256 i, uint256 j, uint256 dx) external view returns (uint256);
```*/
    #[allow(non_camel_case_types, non_snake_case)]
    ...
    ///Container type for the return parameters of the [`get_dy(uint256,uint256,uint256)`](get_dyCall) function.
    #[allow(non_camel_case_types, non_snake_case)]
    #[derive(Clone)]
    ...
    const _: () = {
        ...
        impl alloy_sol_types::SolCall for get_dyCall {
            ...
            type ReturnToken<'a> = <Self::ReturnTuple<
                'a,
            > as alloy_sol_types::SolType>::Token<'a>;
            const SIGNATURE: &'static str = "get_dy(uint256,uint256,uint256)";
            const SELECTOR: [u8; 4] = [85u8, 109u8, 110u8, 159u8];
            #[inline]
            fn new<'a>(
                tuple: <Self::Parameters<'a> as alloy_sol_types::SolType>::RustType,
            ) -> Self {
...
```*/
    ...
    ///Container for all the [`ICurvePoolV2`](self) function calls.
    pub enum ICurvePoolV2Calls {
        A(ACall),
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for ICurvePoolV2Calls {
        const NAME: &'static str = "ICurvePoolV2Calls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<ICurvePoolV2Calls>] = &[
                {
                    fn name(
                        data: &[u8],
                        validate: bool,
                ...
                },
                {
                    fn remove_liquidity_one_coin_0(
                        ...
                        <remove_liquidity_one_coin_0Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::remove_liquidity_one_coin_0)
                    }
                ...
                },
                {
                    fn add_liquidity_0(
                        ...
                        <add_liquidity_0Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::add_liquidity_0)
                    }
                    add_liquidity_0
                },
                {
                    fn add_liquidity_1(
                        ...
                        <add_liquidity_1Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::add_liquidity_1)
                    }
                    add_liquidity_1
                },
                {
                    fn future_A_time(
                        ...
                        <future_A_timeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::future_A_time)
                    }
                    future_A_time
                },
                {
                    fn get_balances(
                        ...
                        <get_balancesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::get_balances)
                    }
                    get_balances
                },
                {
                    fn totalSupply(
                        ...
                        <totalSupplyCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::totalSupply)
                    }
                    totalSupply
                },
                {
                    fn remove_liquidity_one_coin_1(
                        ...
                        <remove_liquidity_one_coin_1Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::remove_liquidity_one_coin_1)
                    }
                ...
                },
                {
                    fn ma_exp_time(
                        ...
                        <ma_exp_timeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::ma_exp_time)
                    }
                    ma_exp_time
                },
                {
                    fn ma_last_time(
                        ...
                        <ma_last_timeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::ma_last_time)
                    }
                    ma_last_time
                },
                {
                    fn initial_A_time(
                        ...
                        <initial_A_timeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::initial_A_time)
                    }
                    initial_A_time
                },
                {
                    fn transferFrom(
                        ...
                        <transferFromCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::transferFrom)
                    }
                    transferFrom
                },
                {
                    fn withdraw_admin_fees(
                        ...
                        <withdraw_admin_feesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::withdraw_admin_fees)
                    }
                    withdraw_admin_fees
                },
                {
                    fn decimals(
                        ...
                        <decimalsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::decimals)
                    }
                    decimals
                },
                {
                    fn DOMAIN_SEPARATOR(
                        ...
                        <DOMAIN_SEPARATORCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::DOMAIN_SEPARATOR)
                    }
                    DOMAIN_SEPARATOR
                },
                {
                ...
                },
                {
                    fn exchange_0(
                        ...
                        <exchange_0Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::exchange_0)
                    }
                    exchange_0
                },
                {
                    fn remove_liquidity_0(
                        ...
                        <remove_liquidity_0Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::remove_liquidity_0)
                    }
                    remove_liquidity_0
                },
                {
                    fn balances(
                        ...
                        <balancesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::balances)
                    }
                    balances
                },
                {
                    fn apply_new_fee(
                        ...
                        <apply_new_feeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::apply_new_fee)
                    }
                    apply_new_fee
                },
                {
                    fn remove_liquidity_imbalance_0(
                        ...
                        <remove_liquidity_imbalance_0Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::remove_liquidity_imbalance_0)
                    }
                ...
                },
                {
                    fn initial_A(
                        ...
                        <initial_ACall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::initial_A)
                    }
                    initial_A
                },
                {
                ...
                },
                {
                    fn stop_ramp_A(
                        ...
                        <stop_ramp_ACall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::stop_ramp_A)
                    }
                    stop_ramp_A
                },
                {
                ...
                },
                {
                    fn future_fee(
                        ...
                        <future_feeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::future_fee)
                    }
                    future_fee
                },
                {
                    fn remove_liquidity_1(
                        ...
                        <remove_liquidity_1Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::remove_liquidity_1)
                    }
                    remove_liquidity_1
                },
                {
                    fn balanceOf(
                        ...
                        <balanceOfCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::balanceOf)
                    }
                    balanceOf
                },
                {
                    fn A_precise(
                        ...
                        <A_preciseCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::A_precise)
                    }
                    A_precise
                },
                {
                ...
                },
                {
                    fn set_ma_exp_time(
                        ...
                        <set_ma_exp_timeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::set_ma_exp_time)
                    }
                    set_ma_exp_time
                },
                {
                    fn price_oracle(
                        ...
                        <price_oracleCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::price_oracle)
                    }
                    price_oracle
                },
                {
                ...
                },
                {
                    fn initialize(
                        ...
                        <initializeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::initialize)
                    }
                    initialize
                },
                {
                    fn commit_new_fee(
                        ...
                        <commit_new_feeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::commit_new_fee)
                    }
                    commit_new_fee
                },
                {
                    fn transfer(
                        ...
                        <transferCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::transfer)
                    }
                    transfer
                },
                {
                    fn future_A(
                        ...
                        <future_ACall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::future_A)
                    }
                    future_A
                },
                {
                    fn get_virtual_price(
                        ...
                        <get_virtual_priceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::get_virtual_price)
                    }
                    get_virtual_price
                },
                {
                    fn ema_price(
                        ...
                        <ema_priceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::ema_price)
                    }
                    ema_price
                },
                {
                ...
                },
                {
                    fn calc_withdraw_one_coin(
                        ...
                        <calc_withdraw_one_coinCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::calc_withdraw_one_coin)
                    }
                ...
                },
                {
                    fn allowance(
                        ...
                        <allowanceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::allowance)
                    }
                    allowance
                },
                {
                    fn exchange_1(
                        ...
                        <exchange_1Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::exchange_1)
                    }
                    exchange_1
                },
                {
                ...
                },
                {
                    fn admin_balances(
                        ...
                        <admin_balancesCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::admin_balances)
                    }
                    admin_balances
                },
                {
                    fn remove_liquidity_imbalance_1(
                        ...
                        <remove_liquidity_imbalance_1Call as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::remove_liquidity_imbalance_1)
                    }
                ...
                },
                {
                    fn admin_action_deadline(
                        ...
                        <admin_action_deadlineCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::admin_action_deadline)
                    }
                ...
                },
                {
                    fn calc_token_amount(
                        ...
                        <calc_token_amountCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::calc_token_amount)
                    }
                    calc_token_amount
                },
                {
                ...
                },
                {
                    fn last_price(
                        ...
                        <last_priceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::last_price)
                    }
                    last_price
                },
                {
                    fn admin_fee(
                        ...
                        <admin_feeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(ICurvePoolV2Calls::admin_fee)
                    }
                    admin_fee
                },
            ];
    ...
    ///Container for all the [`ICurvePoolV2`](self) events.
    pub enum ICurvePoolV2Events {
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolEventInterface for ICurvePoolV2Events {
        const NAME: &'static str = "ICurvePoolV2Events";
    ...
    #[automatically_derived]
    impl alloy_sol_types::private::IntoLogData for ICurvePoolV2Events {
        fn to_log_data(&self) -> alloy_sol_types::private::LogData {
            match self {
    ...
    /**Creates a new wrapper around an on-chain [`ICurvePoolV2`](self) contract instance.

See the [wrapper's documentation](`ICurvePoolV2Instance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> ICurvePoolV2Instance<T, P, N> {
        ICurvePoolV2Instance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<ICurvePoolV2Instance<T, P, N>>,
    > {
        ICurvePoolV2Instance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        ICurvePoolV2Instance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`ICurvePoolV2`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`ICurvePoolV2`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct ICurvePoolV2Instance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for ICurvePoolV2Instance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("ICurvePoolV2Instance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<ICurvePoolV2Instance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> ICurvePoolV2Instance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> ICurvePoolV2Instance<T, P, N> {
            ICurvePoolV2Instance {
    ...
    > ICurvePoolV2Instance<T, P, N> {
        ...
        pub fn get_dy(
            &self,
            i: alloy::sol_types::private::primitives::aliases::U256,
            j: alloy::sol_types::private::primitives::aliases::U256,
