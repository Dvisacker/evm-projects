...
```*/
    ...
    ///Container for all the [`IMorphoBase`](self) function calls.
    pub enum IMorphoBaseCalls {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IMorphoBaseCalls {
        const NAME: &'static str = "IMorphoBaseCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IMorphoBaseCalls>] = &[
                {
                    fn setOwner(
                        data: &[u8],
                        validate: bool,
                ...
                },
                {
                    fn accrueInterest(
                        ...
                        <accrueInterestCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoBaseCalls::accrueInterest)
                    }
                    accrueInterest
                },
                {
                ...
                },
                {
                    fn supplyCollateral(
                        ...
                        <supplyCollateralCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoBaseCalls::supplyCollateral)
                    }
                    supplyCollateral
                },
                {
                ...
                },
                {
                    fn DOMAIN_SEPARATOR(
                        ...
                        <DOMAIN_SEPARATORCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoBaseCalls::DOMAIN_SEPARATOR)
                    }
                    DOMAIN_SEPARATOR
                },
                {
                    fn feeRecipient(
                        ...
                        <feeRecipientCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoBaseCalls::feeRecipient)
                    }
                    feeRecipient
                },
                {
                    fn enableLltv(
                        ...
                        <enableLltvCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoBaseCalls::enableLltv)
                    }
                    enableLltv
                },
                {
                ...
                },
                {
                    fn enableIrm(
                        ...
                        <enableIrmCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoBaseCalls::enableIrm)
                    }
                    enableIrm
                },
                {
                ...
                },
                {
                    fn isAuthorized(
                        ...
                        <isAuthorizedCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoBaseCalls::isAuthorized)
                    }
                    isAuthorized
                },
                {
                ...
                },
                {
                    fn extSloads(
                        ...
                        <extSloadsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoBaseCalls::extSloads)
                    }
                    extSloads
                },
                {
                    fn setAuthorizationWithSig(
                        ...
                        <setAuthorizationWithSigCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoBaseCalls::setAuthorizationWithSig)
                    }
                ...
                },
                {
                    fn withdrawCollateral(
                        ...
                        <withdrawCollateralCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoBaseCalls::withdrawCollateral)
                    }
                    withdrawCollateral
                },
                {
                    fn createMarket(
                        ...
                        <createMarketCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoBaseCalls::createMarket)
                    }
                    createMarket
                },
                {
                ...
                },
                {
                    fn isLltvEnabled(
                        ...
                        <isLltvEnabledCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoBaseCalls::isLltvEnabled)
                    }
                    isLltvEnabled
                },
                {
                    fn liquidate(
                        ...
                        <liquidateCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoBaseCalls::liquidate)
                    }
                    liquidate
                },
                {
                    fn flashLoan(
                        ...
                        <flashLoanCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoBaseCalls::flashLoan)
                    }
                    flashLoan
                },
                {
                    fn setFeeRecipient(
                        ...
                        <setFeeRecipientCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoBaseCalls::setFeeRecipient)
                    }
                    setFeeRecipient
                },
                {
                    fn setAuthorization(
                        ...
                        <setAuthorizationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoBaseCalls::setAuthorization)
                    }
                    setAuthorization
                },
                {
                    fn isIrmEnabled(
                        ...
                        <isIrmEnabledCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoBaseCalls::isIrmEnabled)
                    }
                    isIrmEnabled
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`IMorphoBase`](self) contract instance.

See the [wrapper's documentation](`IMorphoBaseInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IMorphoBaseInstance<T, P, N> {
        IMorphoBaseInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IMorphoBaseInstance<T, P, N>>,
    > {
        IMorphoBaseInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IMorphoBaseInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IMorphoBase`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IMorphoBase`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IMorphoBaseInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IMorphoBaseInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IMorphoBaseInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IMorphoBaseInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IMorphoBaseInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IMorphoBaseInstance<T, P, N> {
            IMorphoBaseInstance {
