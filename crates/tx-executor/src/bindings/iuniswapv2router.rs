                ...
                },
                {
                    fn swapExactTokensForETH(
                        ...
                        <swapExactTokensForETHCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2RouterCalls::swapExactTokensForETH)
                    }
                ...
                },
                {
                    fn getAmountsIn(
                        ...
                        <getAmountsInCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2RouterCalls::getAmountsIn)
                    }
                    getAmountsIn
                },
                {
                ...
                },
                {
                    fn swapTokensForExactETH(
                        ...
                        <swapTokensForExactETHCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2RouterCalls::swapTokensForExactETH)
                    }
                ...
                },
                {
                    fn swapExactETHForTokens(
                        ...
                        <swapExactETHForTokensCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2RouterCalls::swapExactETHForTokens)
                    }
                ...
                },
                {
                    fn getAmountIn(
                        ...
                        <getAmountInCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2RouterCalls::getAmountIn)
                    }
                    getAmountIn
                },
                {
                    fn swapTokensForExactTokens(
                        ...
                        <swapTokensForExactTokensCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2RouterCalls::swapTokensForExactTokens)
                    }
                ...
                },
                {
                    fn WETH(
                        ...
                        <WETHCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2RouterCalls::WETH)
                    }
                    WETH
                },
                {
                    fn quote(
                        ...
                        <quoteCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2RouterCalls::quote)
                    }
                    quote
                },
                {
                    fn factory(
                        ...
                        <factoryCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2RouterCalls::factory)
                    }
                    factory
                },
                {
                ...
                },
                {
                    fn swapETHForExactTokens(
                        ...
                        <swapETHForExactTokensCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IUniswapV2RouterCalls::swapETHForExactTokens)
                    }
...
See the [wrapper's documentation](`IUniswapV2RouterInstance`) for more details.*/
    ...
    >(
        ...
        provider: P,
    ) -> IUniswapV2RouterInstance<T, P, N> {
        IUniswapV2RouterInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IUniswapV2RouterInstance<T, P, N>>,
    > {
        IUniswapV2RouterInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IUniswapV2RouterInstance::<T, P, N>::deploy_builder(provider)
    }
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IUniswapV2RouterInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IUniswapV2RouterInstance<T, P, N> {
        #[inline]
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IUniswapV2RouterInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IUniswapV2RouterInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IUniswapV2RouterInstance<T, P, N> {
