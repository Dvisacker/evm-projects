...
```*/
    ...
    ///Container for all the [`IMorphoStaticTyping`](self) function calls.
    pub enum IMorphoStaticTypingCalls {
        #[allow(missing_docs)]
    ...
    #[automatically_derived]
    impl alloy_sol_types::SolInterface for IMorphoStaticTypingCalls {
        const NAME: &'static str = "IMorphoStaticTypingCalls";
        ...
        fn abi_decode_raw(
            ...
            static DECODE_SHIMS: &[fn(
                &[u8],
                bool,
            ) -> alloy_sol_types::Result<IMorphoStaticTypingCalls>] = &[
                {
                    fn setOwner(
                        data: &[u8],
                        validate: bool,
                        ...
                        <setOwnerCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoStaticTypingCalls::setOwner)
                    }
                    setOwner
                },
                {
                    fn accrueInterest(
                        ...
                        <accrueInterestCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoStaticTypingCalls::accrueInterest)
                    }
                    accrueInterest
                },
                {
                    fn repay(
                        ...
                        <repayCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoStaticTypingCalls::repay)
                    }
                    repay
                },
                {
                    fn supplyCollateral(
                        ...
                        <supplyCollateralCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoStaticTypingCalls::supplyCollateral)
                    }
                    supplyCollateral
                },
                {
                    fn setFee(
                        ...
                        <setFeeCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoStaticTypingCalls::setFee)
                    }
                    setFee
                },
                {
                    fn idToMarketParams(
                        ...
                        <idToMarketParamsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoStaticTypingCalls::idToMarketParams)
                    }
                    idToMarketParams
                },
                {
                    fn DOMAIN_SEPARATOR(
                        ...
                        <DOMAIN_SEPARATORCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoStaticTypingCalls::DOMAIN_SEPARATOR)
                    }
                    DOMAIN_SEPARATOR
                },
                {
                    fn feeRecipient(
                        ...
                        <feeRecipientCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoStaticTypingCalls::feeRecipient)
                    }
                    feeRecipient
                },
                {
                    fn enableLltv(
                        ...
                        <enableLltvCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoStaticTypingCalls::enableLltv)
                    }
                    enableLltv
                },
                {
                    fn borrow(
                        ...
                        <borrowCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoStaticTypingCalls::borrow)
                    }
                    borrow
                },
                {
                    fn enableIrm(
                        ...
                        <enableIrmCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoStaticTypingCalls::enableIrm)
                    }
                    enableIrm
                },
                {
                    fn withdraw(
                        ...
                        <withdrawCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoStaticTypingCalls::withdraw)
                    }
                    withdraw
                },
                {
                    fn market(
                        ...
                        <marketCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoStaticTypingCalls::market)
                    }
                    market
                },
                {
                    fn isAuthorized(
                        ...
                        <isAuthorizedCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoStaticTypingCalls::isAuthorized)
                    }
                    isAuthorized
                },
                {
                    fn nonce(
                        ...
                        <nonceCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoStaticTypingCalls::nonce)
                    }
                    nonce
                },
                {
                    fn extSloads(
                        ...
                        <extSloadsCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoStaticTypingCalls::extSloads)
                    }
                    extSloads
                },
                {
                    fn setAuthorizationWithSig(
                        ...
                        <setAuthorizationWithSigCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoStaticTypingCalls::setAuthorizationWithSig)
                    }
                ...
                },
                {
                    fn withdrawCollateral(
                        ...
                        <withdrawCollateralCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoStaticTypingCalls::withdrawCollateral)
                    }
                    withdrawCollateral
                },
                {
                    fn createMarket(
                        ...
                        <createMarketCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoStaticTypingCalls::createMarket)
                    }
                    createMarket
                },
                {
                    fn owner(
                        ...
                        <ownerCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoStaticTypingCalls::owner)
                    }
                    owner
                },
                {
                    fn position(
                        ...
                        <positionCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoStaticTypingCalls::position)
                    }
                    position
                },
                {
                    fn supply(
                        ...
                        <supplyCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoStaticTypingCalls::supply)
                    }
                    supply
                },
                {
                    fn isLltvEnabled(
                        ...
                        <isLltvEnabledCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoStaticTypingCalls::isLltvEnabled)
                    }
                    isLltvEnabled
                },
                {
                    fn liquidate(
                        ...
                        <liquidateCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoStaticTypingCalls::liquidate)
                    }
                    liquidate
                },
                {
                    fn flashLoan(
                        ...
                        <flashLoanCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoStaticTypingCalls::flashLoan)
                    }
                    flashLoan
                },
                {
                    fn setFeeRecipient(
                        ...
                        <setFeeRecipientCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoStaticTypingCalls::setFeeRecipient)
                    }
                    setFeeRecipient
                },
                {
                    fn setAuthorization(
                        ...
                        <setAuthorizationCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoStaticTypingCalls::setAuthorization)
                    }
                    setAuthorization
                },
                {
                    fn isIrmEnabled(
                        ...
                        <isIrmEnabledCall as alloy_sol_types::SolCall>::abi_decode_raw(
                            ...
                            .map(IMorphoStaticTypingCalls::isIrmEnabled)
                    }
                    isIrmEnabled
                },
            ];
    ...
    /**Creates a new wrapper around an on-chain [`IMorphoStaticTyping`](self) contract instance.

See the [wrapper's documentation](`IMorphoStaticTypingInstance`) for more details.*/
    #[inline]
    pub const fn new<
    ...
    >(
        ...
        provider: P,
    ) -> IMorphoStaticTypingInstance<T, P, N> {
        IMorphoStaticTypingInstance::<T, P, N>::new(address, provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    >(
        ...
        Output = alloy_contract::Result<IMorphoStaticTypingInstance<T, P, N>>,
    > {
        IMorphoStaticTypingInstance::<T, P, N>::deploy(provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(provider: P) -> alloy_contract::RawCallBuilder<T, P, N> {
        IMorphoStaticTypingInstance::<T, P, N>::deploy_builder(provider)
    }
    /**A [`IMorphoStaticTyping`](self) instance.

Contains type-safe methods for interacting with an on-chain instance of the
[`IMorphoStaticTyping`](self) contract located at a given `address`, using a given
provider `P`.
...
See the [module-level documentation](self) for all the available methods.*/
    #[derive(Clone)]
    pub struct IMorphoStaticTypingInstance<T, P, N = alloy_contract::private::Ethereum> {
        address: alloy_sol_types::private::Address,
        provider: P,
        _network_transport: ::core::marker::PhantomData<(N, T)>,
    }
    #[automatically_derived]
    impl<T, P, N> ::core::fmt::Debug for IMorphoStaticTypingInstance<T, P, N> {
        #[inline]
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple("IMorphoStaticTypingInstance").field(&self.address).finish()
        }
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
        ...
        pub async fn deploy(
            provider: P,
        ) -> alloy_contract::Result<IMorphoStaticTypingInstance<T, P, N>> {
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    impl<T, P: ::core::clone::Clone, N> IMorphoStaticTypingInstance<T, &P, N> {
        /// Clones the provider and returns a new instance with the cloned provider.
        #[inline]
        pub fn with_cloned_provider(self) -> IMorphoStaticTypingInstance<T, P, N> {
            IMorphoStaticTypingInstance {
